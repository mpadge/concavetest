...
RcppExport SEXP _concavetest_rcpp_concaveman(SEXP xySEXP, SEXP hull_inSEXP, SEXP concavitySEXP, SEXP lengthThresholdSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_concavetest_rcpp_concaveman", (DL_FUNC) &_concavetest_rcpp_concaveman, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_concavetest(DllInfo *dll) {
